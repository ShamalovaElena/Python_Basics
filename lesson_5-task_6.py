...
Задача 6. Сформировать (не программно) текстовый файл. В нём каждая строка должна описывать учебный предмет
...
def count_subjects():
    try:
        # Информатика: 100(л) 50(пр) 20(лаб).
        my_dict = {}
        with open("file_academic.txt", encoding='utf-8') as fobj:
            for line in fobj:
