...
Задача 7.  Создать вручную и заполнить несколькими строками текстовый файл, в котором каждая строка будет содержать
...
def get_statistics():
    try:
        with open('file_firms.txt', 'r+', encoding='utf-8') as file:
            statistics = []
            profit = {}
            average_profit = {}
            av = 0
