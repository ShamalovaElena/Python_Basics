...
Задача 4. Реализуйте базовый класс Car. у класса должны быть следующие атрибуты: speed, color, name, is_police (булево).
...
class Car(): # АВТОМОБИЛЬ
    ...
    def show_speed(self, speed):
        # Для сокращения объема кода добавила проверку на превышение максимальной
...
my_family_car = TownCar(60, 'красный', 'Honda Stepwgn Spada', False)
my_family_car.go()
